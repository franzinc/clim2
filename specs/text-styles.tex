...
\defgeneric {text-style-ascent}  {text-style port} 
\defgeneric {text-style-descent} {text-style port}
\defgeneric {text-style-height}  {text-style port}
\Defgeneric {text-style-width}   {text-style port}
...
on any medium on the \term{port} \arg{port}.  \arg{text-style} must be a fully
...
\arg{text-style} and \arg{port} arguments.  Implementations should also provide
...
\Defgeneric {text-style-fixed-width-p} {text-style port}

Returns \term{true} if the \term{text styles} \arg{text-style} will map to a
fixed-width font on any medium on the \term{port} \arg{port}, otherwise returns
