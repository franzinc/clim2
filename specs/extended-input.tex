...
accelerator gesture (one of the gestures in \cl{*accelerator-gestures*} is
read from the user.
...
\cl{clim-genera:help} and \cl{clim-genera:complete}.
...
supplied, otherwise it defaults to \term{false}.
...
\issue {SWM} {What function is ``gesture preprocessing'' meant to fulfill?
