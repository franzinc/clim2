...
\Defgeneric {draw-design} {sheet design \key \DrawingOptions \LineJointCapOptions\ \TextOptions}

Draws the \term{design} \arg{design} onto the \term{sheet} \arg{sheet}.  This is
...
drawing plane with current ink of the sheet's medium.  If \arg{design} is a
...
Draws the pattern \arg{pattern} on the \term{sheet} \arg{sheet} at the
...
Use \cl{(draw-design \arg{sheet} (make-pattern \arg{bit-array} (list
