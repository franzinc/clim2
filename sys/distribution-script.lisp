...
;; $fiHeader: distribution-script.lisp,v 1.3 92/07/20 16:00:45 cer Exp $
...
(sct:define-distribution-system clim-binaries
  ...
  (:module clim ("CLIM" "CLIM-Demo") (:type :system) (:version :latest))
  (:serial 
    ";SYS;LOAD-CLIM2.LISP"
    clim
...
(sct:define-distribution-system clim-sources
    (:default-pathname "SYS:CLIM;REL-2;"
     ...
     :source-category :restricted)
  (:module clim ("CLIM" "CLIM-Demo") (:type :system) (:version :newest))
  (:serial 
    ";SYS;LOAD-CLIM2.LISP"
