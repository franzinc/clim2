...
(def-exported-foreign-function (xchangeproperty (:name "XChangeProperty"))
  (dpy (:pointer display))
  (w (:pointer window))
  (property atom)			; changed by MW -> atom
  (type atom)
  (format :int)
  (mode :int)
...
(def-exported-foreign-function (xconvertselection (:name "XConvertSelection"))
  (dpy (:pointer display))
  (selection atom)			; changed by MW -> atom 
  (target atom)				; changed by MW -> atom 
  (property atom)			; changed by MW -> atom
  (requestor (:pointer window))
  (time time))
...
;; added by MW - M1 FFI bug hack 
(def-exported-foreign-function (xcopyarea-patched (:name "lisp_xcopyarea_patched"))
  (dpy (:pointer display))
  (src-drawable drawable)
  (dst-drawable drawable)
  (gc gc))
...
;; added by MW - M1 FFI bug hack 
(def-exported-foreign-function (xcopyarea-setargs (:name "lisp_xcopyarea_setargs"))
  (src-x :int)
  (src-y :int)
  (width :unsigned-int)
  (height :unsigned-int)
...
(def-exported-foreign-function (xcreatepixmap (:return-type pixmap) (:name "XCreatePixmap"))
  (dpy (:pointer display))
  (d (:pointer drawable)) ;; changed by MW
  (width :unsigned-int)
  (height :unsigned-int)
  (depth :unsigned-int))

(def-exported-foreign-function (xcreatesimplewindow (:return-type (:pointer window)) (:name "XCreateSimpleWindow"))
  (dpy (:pointer display))
...
(def-exported-foreign-function (xalloccolor (:return-type :int) (:name "XAllocColor"))
  (dpy (:pointer display))
  (cmap (:pointer colormap))
  (def (:pointer xcolor)))

(def-exported-foreign-function (xgetinputfocus (:name "XGetInputFocus"))
  (dpy (:pointer display))
  (focus (:pointer (:pointer window))) ;; really pointer to pointer?? MW
...
(def-exported-foreign-function (xgetmotionevents (:return-type (:pointer xtimecoord)) (:name "XGetMotionEvents"))
  (dpy (:pointer display))
  (w (:pointer window))			; changed position by MW! 
  (start time) 
  (stop time)
  (nevents (:pointer :int)))
...
(def-exported-foreign-function (xgetkeyboardmapping (:return-type (:pointer keysym)) (:name "XGetKeyboardMapping"))
  (dpy (:pointer display))
  (first-keycode :char) ;; (first-keycode keycode)
  (count :int)
...
(def-exported-foreign-function (xgetwindowproperty (:return-type :int) (:name "XGetWindowProperty"))
  (dpy (:pointer display))
  (w (:pointer window))
  (property atom)			; atoms are :unsigned 32 bit in X... double check! changed by MW -> atom 
  (offset :long)
  (length :long)
  (delete :int)				; boolean as :int -> double check, ok! 
  (req-type atom)			; changed by MW -> atom
...
(def-exported-foreign-function (xgetselectionowner (:return-type (:pointer window)) (:name "XGetSelectionOwner"))
  (dpy (:pointer display))
  (selection atom))			; changed by MW -> atom
...
(def-exported-foreign-function (xgrabbutton (:name "XGrabButton"))
  ...
  (button :unsigned-int)
  (grab-window (:pointer window))
  (owner-events :int)
  (event-mask :unsigned-int)
  (pointer-mode :int)
  (keyboard-mode :int)
  (confine-to (:pointer window))
  (curs cursor))
...
(def-exported-foreign-function (xeheadofextensionlist (:return-type (:pointer (:pointer xextdata)))
...
(def-exported-foreign-function (xinternatom (:return-type atom) (:name "XinternAtom"))
  (dpy (:pointer display))
  (name (:pointer :char))
  (onlyifexists :int))
...
(def-exported-foreign-function (xrootwindow (:return-type (:pointer window)) (:name "XRootWindow"))
  (dpy (:pointer display))
  (scr :int))
...
(def-exported-foreign-function (xdefaultrootwindow (:return-type (:pointer window)) (:name "XDefaultRootWindow"))
  (dpy (:pointer display)))
...
(def-exported-foreign-function (xrootwindowofscreen (:return-type (:pointer window)) (:name "XRootWindowOfScreen"))
  (s (:pointer screen)))
...
(def-exported-foreign-function (xpending (:return-type :fixnum) (:name "XPending"))
  (dpy (:pointer display)))
...
(def-exported-foreign-function (xquerypointer (:return-type :int) (:name "XQueryPointer"))
  (dpy (:pointer display))
  (w (:pointer window))
  (root (:pointer (:pointer window)))
  (child (:pointer (:pointer window)))
  (root-x (:pointer :int))
  (root-y (:pointer :int))
  (win-x (:pointer :int))
  (win-y (:pointer :int))
...
(def-exported-foreign-function (xquerytree (:return-type :int) (:name "XQueryTree"))
  (dpy (:pointer display))
  (w (:pointer window)) ;; double check the pointer to pointer 
  (root (:pointer (:pointer window)))
  (parent (:pointer (:pointer window)))
  (children (:pointer (:pointer (:pointer window))))
...
(def-exported-foreign-function (xrestackwindows (:name "XRestackWindows"))
  (dpy (:pointer display))
  (windows (:pointer (:pointer window)))
  (n :int))
...
(def-exported-foreign-function (xtranslatecoordinates (:return-type :int) (:name "XTranslateCoordinates"))
  (dpy (:pointer display))
  (src-win (:pointer window))
  (dest-win (:pointer window))
  (src-x :int)
  (src-y :int)
  (dst-x (:pointer :int))
  (dst-y (:pointer :int))
...
(def-exported-foreign-function (xcreatewindow (:return-type (:pointer window)) (:name "XCreateWindow"))
  (dpy (:pointer display))
  (parent (:pointer window))
  (x :int)
  (y :int)
...
(def-exported-foreign-function (xsavecontext (:return-type :fixnum)
					     (:name "XSaveContext"))
  (window (:pointer window))
  (context xcontext)
  (data (:pointer :char)))

(def-exported-foreign-function (xfindcontext (:return-type :fixnum)
					     (:name "XFindContext"))
  (display (:pointer display))
  (window (:pointer window))
  (context xcontext)
...
(def-exported-foreign-function (xdeletecontext (:return-type :fixnum)
					       (:name "XDeleteContext"))
  (window (:pointer window))
  (context xcontext))

(def-exported-foreign-function (xfilterevent (:return-type :fixnum)
                                             (:name "XFilterEvent"))
  (event (:pointer xevent))
  (window (:pointer window)))

(def-exported-foreign-function (xlookupstring (:return-type :fixnum)
					      (:name "XLookupString"))
...
;;; Franz / MacOS compiler bug Basically, FFI with more than 9 args
;;; are currently not supported. The corresponding definitions are in
;;; xlibsupport.c

(def-exported-foreign-function (xcopyarea_test (:name "lisp_mw_test_copy"))
  (dpy (:pointer display))
  (src-drawable drawable)
  (dst-drawable drawable)
  (gc gc)
...
(def-exported-foreign-function (mw_test_args (:name "lisp_mw_test_args"))
  (a1 :int)
  (a2 :int)
  (a3 :int)
  (a4 :int)
...
(def-exported-foreign-function (mw_test_args2 (:name "lisp_mw_test_args2"))
    (a1 :unsigned-long)
  (a2 :unsigned-long)
  (a3 :unsigned-long)
  (a4 :unsigned-long)
...
(def-exported-foreign-function (xmwtest (:return-type :int) (:name "lisp_mw_test"))
    (x :int))

(def-exported-foreign-function (xmwtest2 (:return-type :int) (:name "lisp_mw_test2"))
  (dpy (:pointer display)))

(def-exported-foreign-function (xmwtest3 (:return-type (:pointer display)) (:name "lisp_mw_test3"))
  (dpy (:pointer display)))
